...
def main(args: argparse.Namespace, root_dir: str, prompts: List[str]) -> None:
    ...
    for prompt in prompts:
        ...
        if len(results.images) > 1:
            for i, image in enumerate(results.images):
                ...
                image.save(f"{image_name}_{timestamp}_{i}{ext}")
                print(f"Saved {image_name}_{timestamp}_{i}{ext}")
