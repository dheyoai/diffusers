...
from diffusers.omnigen2.pipelines.image_processor import OmniGen2ImageProcessor

from diffusers.omnigen2.utils.teacache_util import TeaCacheParams
...
class OmniGen2Pipeline(DiffusionPipeline, OmniGen2LoraLoaderMixin):
    ...
    def __call__(
        ...
        max_input_image_side_length: int = 32,
        align_res: bool = True,
